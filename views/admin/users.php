...
<body class="nk-body bg-lighter npc-general has-sidebar dark-mode">
                                                ...
                                                <div class="card-inner p-0 border-top">
                                                    <div class="nk-tb-list nk-tb-orders">
                                                        <div class="nk-tb-item nk-tb-head">
                                                            <div class="nk-tb-col"><span>User ID</span></div>
                                                            <div class="nk-tb-col tb-col-sm"><span>Email</span></div>
                                                            <div class="nk-tb-col tb-col-md"><span>Creation Date</span></div>
                                                            <div class="nk-tb-col tb-col-lg"><span>Rank</span></div>
                                                            <div class="nk-tb-col"><span>Phone No</span></div>
                                                            <div class="nk-tb-col"><span class="d-none d-sm-inline">Delete</span></div>
                                                        </div>
                                                       
                                                        <?php if($users !== false) foreach($users as $val){ ?>
                                                        <div class="nk-tb-item">
                                                            <div class="nk-tb-col">
                                                                <span class="tb-lead"><?= $val['user_id']; ?></a></span>
                                                            </div>
                                                            <div class="nk-tb-col tb-col-sm">
                                                                <div class="user-card">
                                                                    <div class="user-avatar user-avatar-sm bg-purple">
                                                                        <span><?= $val['rank'] == 0 ? "User" : "Admin"; ?></span>
                                                                    </div>
                                                                    <div class="user-name">
                                                                        <span class="tb-lead"><?= $val['email']; ?></span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="nk-tb-col tb-col-lg">
                                                                <span class="tb-sub text-primary"><?= $val['rank'] == 0 ? "User" : "Admin"; ?></span>
                                                            </div>
                                                            <div class="nk-tb-col">
                                                                <span class="tb-sub tb-amount"><span><?=  $val['phonenumber'] == null ? "Not Set" :  $val['phonenumber']; ?></span>
                                                            </div>
                                                            <div class="nk-tb-col">
                                                                <span class=""><button class="user-delete btn btn-lg btn-primary btn-block" value="<?= $val['user_id']; ?>">Delete</button></span>
                                                            </div>
                                                        </div>
                                                        <?php } ?>
                                                    </div>
    ...
    <script src="./assets/js/modules/admin_users.js"></script>
